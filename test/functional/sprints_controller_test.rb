...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { date_begin: @sprint.date_begin, date_final: @sprint.date_final, name: @sprint.name }
    end
  ...
  test "should update sprint" do
    put :update, id: @sprint, sprint: { date_begin: @sprint.date_begin, date_final: @sprint.date_final, name: @sprint.name }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
